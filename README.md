...
views receives a session or can read workbook data or operational APIs. Pickup / Drop Plan and Food
Pickup filter their visible cards locally by free text and date; search text is not sent to the server.
